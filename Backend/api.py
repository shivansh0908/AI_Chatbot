...
async def ask(req: QueryRequest):
    ...
    system_prompt = (
        ...
        "If the answer is not supported by the context, respond with: "
        "'I don't know based on the provided data.' "
        "You may paraphrase and infer logically, but do not add new facts."
    )

    user_prompt = (
        f"CONTEXT:\n{context_text}\n\n"
        f"QUESTION:\n{q}\n\n"
        "Instruction: Answer concisely. Use short bullet points or a short paragraph. "
